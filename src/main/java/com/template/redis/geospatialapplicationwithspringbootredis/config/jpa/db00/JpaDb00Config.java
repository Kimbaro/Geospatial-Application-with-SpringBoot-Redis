package com.template.redis.geospatialapplicationwithspringbootredis.config.jpa.db00;
...
@EnableJpaRepositories(
        basePackages = {"com.template.redis.geospatialapplicationwithspringbootredis.db.db00.repo"},
...
public class JpaDb00Config {
    ...
    public LocalContainerEntityManagerFactoryBean db00EntityManager() {
        ...
        em.setPackagesToScan("com.template.redis.geospatialapplicationwithspringbootredis.db.db00.entity");
